---
title: "Building multivariate visualizations <br> with ggplot2"
subtitle: "Max Planck School of Cognition"
author: "Dr. Mine Çetinkaya-Rundel"
date: "6 Jan 2020 <br><br> INSERT LINK"
output:
...
```{r load-daily-data, message=FALSE, eval=TRUE} 
...
```{r load-durham-voters-data, message=FALSE, eval=TRUE} 
...
**Exercise:** Which of the two datasets does this visualization use? Determine 
...
```{r days-reordered, fig.height=2, fig.show="hide"}
daily <- daily %>%
...
```{r ref.label = "days-reordered", echo = FALSE}
```
...
**Exercise:** How would you fix the following plot to color by day of week?
...
```{r facet-layer, echo = FALSE, fig.height = 3, fig.width=7}
```
...
```{r ref.label="facet-layer", eval = FALSE}
durham_voters_summary %>% 
